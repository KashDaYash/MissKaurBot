...
from MissKaur import BOT_USERNAME, OWNER_ID, pgram, arq
from MissKaur.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from MissKaur.utils.pluginhelpers import fetch
from MissKaur import BOT_USERNAME
...
async def alive_function(answers):
    ...
    msg = f"""
**[MissKaur](https://github.com/TeamMissKaur/MissKaur):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
