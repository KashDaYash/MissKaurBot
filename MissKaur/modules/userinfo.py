...
from MissKaur.__main__ import STATS, TOKEN, USER_INFO
from MissKaur.modules.sql import SESSION
import MissKaur.modules.sql.userinfo_sql as sql
from MissKaur.modules.disable import DisableAbleCommandHandler
from MissKaur.modules.sql.global_bans_sql import is_user_gbanned
from MissKaur.modules.redis.afk_redis import is_user_afk, afk_reason
from MissKaur.modules.sql.users_sql import get_user_num_chats
from MissKaur.modules.helper_funcs.chat_status import sudo_plus
from MissKaur.modules.helper_funcs.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user_id not in [bot.id, 777000, 1087968824]:
        ...
        text += f"\n\n<b>Health:</b> <code>{userhp['earnedhp']}/{userhp['totalhp']}</code>\n[<i>{make_bar(int(userhp['percentage']))} </i>{userhp['percentage']}%]. [<a href='https://t.me/TeamMissKaur/13'>?</a>]"
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThis user is member of 'TeamMissKaur'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/TeamMissKaur/9">?</a>]'.format(
            bot.username,
        )
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + f"\n\n[✦ Support](https://t.me/{SUPPORT_CHAT}) | [✦ Updates](https://t.me/TeamMissKaur)\n\n"
            + "╘══「 by [Team MissKaur](https://github.com/TeamMissKaur) 」\n",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/TeamMissKaur/13)
"""
