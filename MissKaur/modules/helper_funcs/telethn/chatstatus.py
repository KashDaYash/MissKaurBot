...
from MissKaur import DRAGONS
from MissKaur.modules.helper_funcs.telethn import IMMUNE_USERS, telethn
...
async def MissKaur_is_admin(chat_id: int):
    status = False
