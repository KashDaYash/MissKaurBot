...
import MissKaur.modules.sql.notes_sql as sql
from MissKaur import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from MissKaur.__main__ import DATA_IMPORT
from MissKaur.modules.helper_funcs.chat_status import user_admin
from MissKaur.modules.helper_funcs.alternate import typing_action

from MissKaur.modules.rules import get_rules
import MissKaur.modules.sql.rules_sql as rulessql

from MissKaur.modules.sql import warns_sql as warnssql
import MissKaur.modules.sql.blacklist_sql as blacklistsql
from MissKaur.modules.sql import disable_sql as disabledsql

from MissKaur.modules.sql import cust_filters_sql as filtersql
import MissKaur.modules.sql.welcome_sql as welcsql
import MissKaur.modules.sql.locks_sql as locksql
from MissKaur.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("MissKaur{}Backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("MissKaur{}Backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `MissKaur-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl,
        ),
        timeout=360,
    ...
    os.remove("MissKaur{}Backup".format(chat_id))  # Cleaning file
