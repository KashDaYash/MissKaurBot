import MissKaur.modules.sql.global_bans_sql as gban_sql
import MissKaur.modules.sql.users_sql as user_sql

from time import sleep
from MissKaur import DEV_USERS, OWNER_ID, dispatcher
