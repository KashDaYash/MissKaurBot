...
from MissKaur.modules.helper_funcs.alternate import typing_action, send_action
...
def src(update, _):
    update.effective_message.reply_text(
        "Hey there! You can find what makes me click [here](https://github.com/TeamMissKaur/MissKaur).",
        parse_mode=ParseMode.MARKDOWN,
        disable_web_page_preview=True,
    )
