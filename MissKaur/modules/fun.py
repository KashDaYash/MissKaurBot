...
import MissKaur.modules.fun_strings as fun_strings

from pyrogram import filters
from pathlib import Path
from MissKaur import DEMONS, DRAGONS, pgram as bot, dispatcher, BOT_USERNAME, BOT_NAME
...
def slap(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        temp = random.choice(fun_strings.SLAP_MissKaur_TEMPLATES)
